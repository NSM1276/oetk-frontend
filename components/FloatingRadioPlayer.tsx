...
export default function FloatingRadioPlayer() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-45 w-[280px]">
      {/* Floating widget container with blur backdrop */}
      <div className="rounded-xl shadow-2xl bg-cream/95 backdrop-blur-md overflow-hidden border border-line/40">
        {/* Header */}
        <div className="px-4 py-3 flex items-center gap-2 border-b border-line/30">
          <div className="w-5 h-5 text-burgundy text-lg">🎙️</div>
          <span className="text-sm font-medium text-ink font-display tracking-tight">
            OETK FM
          </span>
        </div>
